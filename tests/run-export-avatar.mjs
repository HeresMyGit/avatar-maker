...
const outfile = fileURLToPath(new URL('.export-avatar.test.mjs', import.meta.url));
try {
  await build({ entryPoints: [fileURLToPath(new URL('export-avatar.test.mjs', import.meta.url))], outfile,
